#Course : CS 513
#GROUP MEMBERS
#Ankita Sawant CS-513-A(10412051)
#Muskaan Mulchandani CS-513-B(10411601)
#Pinkal Ganjawala CS-513-B (10411758)
#Shradha Nayak CS-513-B (10411519)
...
data<-read.csv("C:/Users/anki/Desktop/Stevens/SEM 1/513/Project/Code/dataset/20April.csv")
